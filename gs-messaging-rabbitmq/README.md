...
## What you’ll build
You’ll build an application that publishes a message using Spring AMQP’s `RabbitTemplate` and subscribes to the message on a [POJO](http://spring.io/understanding/POJO) using `MessageListenerAdapter`.
...
* [Download](https://github.com/spring-guides/gs-messaging-rabbitmq/archive/master.zip) and unzip the source repository for this guide, or clone it using [Git](http://spring.io/understanding/Git): `git clone https://github.com/spring-guides/gs-messaging-rabbitmq.git`
* cd into `gs-messaging-rabbitmq/initial`
* Jump ahead to [Create a RabbitMQ message receiver](#create-a-rabbitmq-message-receiver).
...
Below is the [initial Gradle build file](https://github.com/spring-guides/gs-messaging-rabbitmq/blob/master/initial/build.gradle).
