...
This guide walks you through the process of creating an application that accesses relational JPA data through a [hypermedia-based RESTful](http://spring.io/guides/gs/rest-hateoas) front end.

## What you’ll build
You’ll build a Spring application that let’s you create and retrieve `Person` objects stored in a database using Spring Data REST. Spring Data REST takes the features of [Spring HATEOAS](https://projects.spring.io/spring-hateoas) and [Spring Data JPA](https://projects.spring.io/spring-data-jpa) and combines them together automatically.

> Spring Data REST also supports [Spring Data Neo4j](http://spring.io/guides/gs/accessing-neo4j-data-rest), [Spring Data Gemfire](http://spring.io/guides/gs/accessing-gemfire-data-rest) and [Spring Data MongoDB](http://spring.io/guides/gs/accessing-mongodb-data-rest) as backend data stores, but those are not part of this guide.
...
* [Download](https://github.com/spring-guides/gs-accessing-data-rest/archive/master.zip) and unzip the source repository for this guide, or clone it using [Git](http://spring.io/understanding/Git): `git clone https://github.com/spring-guides/gs-accessing-data-rest.git`
...
Below is the [initial Gradle build file](https://github.com/spring-guides/gs-accessing-data-rest/blob/master/initial/build.gradle).
...
## Summary
Congratulations! You’ve just developed an application with a [hypermedia-based RESTful](http://spring.io/guides/gs/rest-hateoas) front end and a JPA-based back end.